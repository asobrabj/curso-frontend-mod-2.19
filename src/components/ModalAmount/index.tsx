          ...
          <Controller
            ...
            render={({ field }) => (
              <>
                ...
                />
                {errors.to && (
                  <span className='error'>{errors.to.message as string}</span>
                )}
                {!field.value ? (
                  <span>Digite uma moeda</span>
                ) : (
                  <span className='no-visible'>_</span>
                )}
              </>
            )}
          />
          ...
          <Controller
            ...
            render={({ field }) => (
              <>
                ...
                />
                {errors.from && (
                  <span className='error'>{errors.from.message as string}</span>
                )}
                {!field.value && <span>Digite uma moeda</span>}
              </>
            )}
          />
        </S.ContainerInput>
